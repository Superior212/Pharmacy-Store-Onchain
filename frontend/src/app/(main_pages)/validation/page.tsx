...
type Transaction = {
  ...
  const transactions: Transaction[] = [
    {
      id: '456789356',
      Transactiondate: 'Oct 10, 2024, 04:30pm',
      prescriptionId: '56743',
      From: '0x00000000000',
      Action: 'Confirm',
    },
    {
      id: '456789356',
      Transactiondate: 'Oct 14, 2024, 02:00pm',
      prescriptionId: '89505',
      From: '0x000000000000000',
      Action: 'Confirm',
    },
    {
      id: '456789356',
      Transactiondate: 'Oct 16, 2024, 08:00pm',
      prescriptionId: '46735',
      From: '0x000000000000000',
      Action: 'Canceled',
    },
    {
      id: '456789356',
      Transactiondate: 'Oct 19, 2024, 05:30pm',
      prescriptionId: '53728',
      From: '0x000000000000000',
      Action: 'Confirmed',
    },
  ];
  
  const getActionClass = (Action: 'Confirmed' | 'Confirm' | 'Canceled') => {
    switch (Action) {
      case 'Canceled':
        ...
        <table className="min-w-full bg-white">
          <thead>
            <tr>
              ...
              <th className="py-2 px-4 border-b-2 border-gray-200 text-left text-gray-600 font-bold uppercase">From</th>
          ...
          <tbody>
            {transactions.map((transaction) => (
              <tr key={transaction.id}>
                ...
                <td className="py-3 px-4 border-b border-gray-200">{transaction.Transactiondate}</td>
                <td className="py-3 px-4 border-b border-gray-200">{transaction.prescriptionId}</td>
                <td className="py-3 px-4 border-b border-gray-200">{transaction.From}</td>
