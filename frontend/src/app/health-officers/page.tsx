...
const ProfileSetup: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState('Health Officers');
    ...
    <div className="md:w-3/4 w-full m-auto p-7">
        ...
        <form>
          <div className='grid grid-cols-2 gap-4 mb-4'>
            <div>
            <input type="text" placeholder="Your First Name" onChange={handleInputChange} className="mt-1 block w-full bg-gray-100 rounded-md outline-none shadow-sm p-2" />
          </div>
          <div>
            <select aria-placeholder='Years Of Experience' onChange={handleInputChange} className="mt-1 block w-full outline-none bg-gray-100 rounded-md shadow-sm p-2">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            <input type="text" placeholder="Your Last NAme" onChange={handleInputChange} className="mt-1 block w-full outline-none bg-gray-100 rounded-md shadow-sm p-2" />
          </div>
          <div>
        ...
        <div className='col-span-2'>
            <input type="text" placeholder="Describe Yourself" onChange={handleInputChange} className="mt-1 block w-full bg-gray-100 rounded-md shadow-sm p-2" />
          </div>
          <div className='col-span-2 flex items-center gap-5 bg-gray-100 p-2 rounded-md'>
          <input
            type="text"
            placeholder='Medical License Number'
            className="mt-1 block w-full bg-gray-100 rounded-md shadow-sm p-2"
        ...
        <div className="grid grid-cols-4 gap-4 mb-4">
          ...
          <div className='col-span-2 flex items-center gap-5 bg-gray-100 p-2 rounded-md'>
          <span className="flex-grow">Upload Medical Certificate</span>
