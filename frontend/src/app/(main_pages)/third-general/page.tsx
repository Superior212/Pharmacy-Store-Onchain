...
const UserProfile: React.FC = () => {
  const [activeTab, setActiveTab] = useState('/third-general');
    ...
    <div className="w-full  p-6 mt-14 bg-white shadow-sm rounded-lg">
      ...
      <div className="mt-6">
        ...
        {activeTab === '/validations' && (
          <div>
            <h2 className="text-xl font-semibold mb-4">Validations</h2>
            <p>Your Validations details will be displayed here.</p>
          </div>
        )}
