        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            <input
              ...
              className="mt-1 block w-full bg-gray-100 rounded-md outline-none shadow-sm p-2"
            />
          </div>
          <div>
            <select
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div>
            <input
              ...
              onChange={handleInputChange}
              className="mt-1 block outline-none w-full bg-gray-100 rounded-md shadow-sm p-2"
            />
          </div>
        </div>
