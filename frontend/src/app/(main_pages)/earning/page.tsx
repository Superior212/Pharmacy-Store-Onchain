  ...
  const transactions: Transaction[] = [
    {
      ...
      ReceivedFrom: '0x000000000000000',
      amount: '0.002ETH',
      status: 'Completed',
    },
    {
...
const tabs = [
  ...
  { name: 'Earnings & Wallets', path: '/earning' },
        ...
        <table className="min-w-full bg-white">
          <thead>
            <tr>
              ...
              <th className="py-2 px-4 border-b-2 border-gray-200 text-left text-gray-600 font-bold uppercase">Received From</th>
          ...
          <tbody>
            {transactions.map((transaction) => (
              <tr key={transaction.id}>
                ...
                <td className="py-3 px-4 border-b border-gray-200">{transaction.ReceivedFrom}</td>
